      ...
      <div class="modal-body">
      	...
      	<form method=POST>
              ...
              <div class="form-group">
                ...
                <label for="exampleFormControlInput1">Forma de Pagamentos</label>
        ...
        <div class="form-group">
              <label for="exampleFormControlInput1">Rede de Pagamento / Plano de Saúde</label>
              <input type="text" class="form-control" id="tipo" placeholder="Rede de Pagamento / Plano de Saúde" name="tipo" required>
        </div>
