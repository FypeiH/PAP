...
$resultado = $pdo->prepare("UPDATE pacientes set nome = :nome, nif = :nif, cc = :cc, telefone = :telefone, email = :email, data_nascimento = :data_nascimento, idade = :idade, estado_civil = :estado_civil, sexo = :sexo, endereco = :endereco, password = :password, obs = :obs where id = :id");
