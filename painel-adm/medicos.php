...
<div class="row botao-novo">
    ...
    <a href="index.php?acao=<?php echo $pagina; ?>&funcao=novo" type="button" class="btn btn-light">Novo Médico</a>
...
<div class="col-md-6 col-sm-12">
  <div class="float-right mr-4">
   ...
   <form id="frm" class="form-inline my-2 my-lg-0" method=POST>
     ...
     <input class="form-control form-control-sm mr-sm-2 " type="search" placeholder="Pesquisar Nome/Cédula" aria-label="Search" name="txtpesquisar" id="txtpesquisar">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
          ...
          <?php if (@$_GET['funcao'] == 'editar') {
            ...
            $resultado = $pdo->query("SELECT * from utilizadores where nivel = 'Médico' and id = '$id_registo'");
          ...
          else{$nome_botao = 'Salvar'; echo 'Registo de Médicos';} 
      ...
      <div class="modal-body">
      	...
      	<form id="form" method=POST enctype="multipart/form-data">
      		<div class="row">
                ...
                <input type="hidden" id="nif_antigo" name="nif_antigo" value="<?php echo @$nif ?>">
        ...
        <div class="row">
         <div class="col-md-4 col-sm-12">
          <div class="form-group">
           ...
           <input type="text" class="form-control" id="cedula" placeholder="Cédula" name="cedula" value="<?php echo @$cedula ?>" required>
         </div>
       </div>
     ...
     <div class="col-md-4 col-sm-12">
      <div class="form-group">
       ...
       <input type="text" class="form-control" id="telefone" placeholder="Telefone" name="telefone" value="<?php echo @$telefone ?>" >
     </div>
   </div>
 </div>
            ...
            <div class="modal-body">
              ...
              <select class="form-control" id="" name="nivel">
                <?php 
                  ...
                  $resultado = $pdo->query("SELECT * from utilizadores where nivel = 'Admin' and id = '$id'");
