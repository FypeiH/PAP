...
<div class="row botao-novo">
    ...
    <a href="index.php?acao=<?php echo $pagina; ?>&funcao=novo" type="button" class="btn btn-light">Novo Atendimento</a>
...
<div class="col-md-6 col-sm-12">
  <div class="float-right mr-4">
   ...
   <form id="frm" class="form-inline my-2 my-lg-0" method=POST>
     ...
     <input class="form-control form-control-sm mr-sm-2 " type="search" placeholder="Pesquisar Descrição" aria-label="Search" name="txtpesquisar" id="txtpesquisar">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
          ...
          <?php if (@$_GET['funcao'] == 'editar') {
            ...
            $resultado = $pdo->query("SELECT * from atendimentos where id = '$id_registo'");
          ...
          } else{$nome_botao = 'Salvar'; echo 'Registo de Atendimentos';} 
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <label for="exampleFormControlInput1">Tipo Atendimento</label>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="valor" placeholder="Valor" name="valor" value="<?php echo @$valor ?>" required>
...
<!-- Código do botão "Novo Atendimento" -->
