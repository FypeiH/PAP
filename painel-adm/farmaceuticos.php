...
<div class="row botao-novo">
    ...
    <a href="index.php?acao=<?php echo $pagina; ?>&funcao=novo" type="button" class="btn btn-light">Novo Farmacêutico</a>
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
          ...
          <?php if (@$_GET['funcao'] == 'editar') {
            ...
            $resultado = $pdo->query("SELECT * from utilizadores where nivel = 'Farmacêutico' and id = '$id_registo'");
            ...
            echo 'Edição de Farmacêuticos';
          } else{$nome_botao = 'Salvar'; echo 'Registo de Farmacêuticos';} 
