...
$resultado_verificar = $pdo->prepare("SELECT * from utilizadores where nif = '$nif'");
...
if($linhas == 0)
{
	...
	//Buscar o id do cargo
		$resultado_cargo_i = $pdo->query("SELECT * from cargos where nome = 'Médico' or nome = 'Medico' or nome = 'médico' or nome = 'medico'");
