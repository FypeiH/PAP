	...
	<div class="row">
		<div class="col-md-3 col-sm-12 mb-4">
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
				...
				<a class="nav-link <?php echo $item2ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item2 ?>" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fas fa-user-md mr-1"></i>Registo de Administradores</a>
				...
				<a class="nav-link <?php echo $item4ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item4 ?>" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fas fa-user-md mr-1"></i>Registo de Farmacêuticos</a>

				<a class="nav-link <?php echo $item5ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item5 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-user mr-1"></i>Registo de Recepcionistas</a>

				<a class="nav-link <?php echo $item6ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item6 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-user mr-1"></i>Registo de Tesoureiros</a>
				...
				<a class="nav-link <?php echo $item8ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item8 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-user mr-1"></i>Registo de Funcionários</a>

				<a class="nav-link <?php echo $item9ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item9 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-user mr-1"></i>Registo de Especialidades</a>

				<a class="nav-link <?php echo $item10ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item10 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-user mr-1"></i>Registo de Atendimentos</a>

				<a class="nav-link <?php echo $item11ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item11 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-user mr-1"></i>Registo de Cargos</a>

				<?php if($notificacoes>0){ ?>

					<a class="nav-link <?php echo $item12ativo ?>" id="v-pills-messages-tab" href="index.php?acao=<?php echo $item12 ?>" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-bell"></i>Notificações <span class="badge badge-light"><?php echo $notificacoes; ?></span></a>
				<?php } ?>
