...
<div class="row botao-novo">
    ...
    <a href="index.php?acao=<?php echo $pagina; ?>&funcao=novo" type="button" class="btn btn-light">Nova Especialidade</a>
...
<div class="col-md-6 col-sm-12">
  <div class="float-right mr-4">
   ...
   <form id="frm" class="form-inline my-2 my-lg-0" method=POST>
     ...
     <input class="form-control form-control-sm mr-sm-2 " type="search" placeholder="Pesquisar Especialidade" aria-label="Search" name="txtpesquisar" id="txtpesquisar">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
          ...
          <?php if (@$_GET['funcao'] == 'editar') {
            ...
            $resultado = $pdo->query("SELECT * from especialidades where id = '$id_registo'");
          ...
          } else{$nome_botao = 'Salvar'; echo 'Registo de Especialidades';} 
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <label for="exampleFormControlInput1">Nome da Especialidade</label>
