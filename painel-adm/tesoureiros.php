...
<div class="row botao-novo">
    ...
    <a href="index.php?acao=<?php echo $pagina; ?>&funcao=novo" type="button" class="btn btn-light">Novo Tesoureiro</a>
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
          ...
          <?php if (@$_GET['funcao'] == 'editar') {
            ...
            $resultado = $pdo->query("SELECT * from utilizadores where nivel = 'Tesoureiro' and id = '$id_registo'");
            ...
            echo 'Edição de Tesoureiros';
          } else{$nome_botao = 'Salvar'; echo 'Registo de Tesoureiros';} 
...
if(@$_GET['funcao'] == 'novo' && @$item_paginado == '')
  ...
  if(@$_GET['funcao'] == 'editar' && @$item_paginado == '')
    ...
    if(@$_GET['funcao'] == 'desativar' && @$item_paginado == '')
    {  
      $id = $_GET['id'];
    ...
    <script>$('#modal-desativar').modal("show")</script>
            ...
            <div class="modal-body">
              <form method=POST>
                <select class="form-control" id="" name="nivel">
                  ...
                  if($nivel != 'Recepcionista'){echo '<option value="Tesoureiro">Recepcionista</option>';}
