...
<div class="row botao-novo">
    ...
    <a href="index.php?acao=<?php echo $pagina; ?>&funcao=novo" type="button" class="btn btn-light">Novo Administrador</a>
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
          ...
          <?php if (@$_GET['funcao'] == 'editar') {
            ...
            echo 'Edição de Administradores';
          } else{$nome_botao = 'Salvar'; echo 'Registo de Administradores';} 
