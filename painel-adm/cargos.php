...
<div class="row botao-novo">
  <div class="col-md-12">
    ...
    <a href="index.php?acao=<?php echo $pagina; ?>&funcao=novo" type="button" class="btn btn-light">Novo Cargo</a>
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
          ...
          <?php if (@$_GET['funcao'] == 'editar') {
            ...
            $resultado = $pdo->query("SELECT * from cargos where id = '$id_registo'");
          ...
          } else{$nome_botao = 'Salvar'; echo 'Registo de Cargos';} 
      ...
      <div class="modal-body">
        ...
        <form method=POST>
          ...
          <div class="form-group">
            ...
            <label for="exampleFormControlInput1">Nome do Cargo</label>
