					...
					<div class="col-sm-12 col-lg-6 col-md-12 col-sm-12 mb-4">
						<div class="card card-stats">
							<div class="card-body ">
								<div class="row">
									...
									<div class="col-7 col-md-8">
										<div class="number">
											<h2 class="titulo-card">Tesoureiro</h2>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="card-footer rodape-card">
								<a href="../painel-tesoureiro/index.php" class="btn btn-info btn-lg btn-block text-decoration-none">Aceder ao Painel Profissional</a>
