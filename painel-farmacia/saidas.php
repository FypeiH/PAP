...
<div class="row botao-novo">
  <div class="col-md-12">
    ...
    <a href="index.php?acao=<?php echo $pagina; ?>&funcao=novo" type="button" class="btn btn-light">Novo Saída</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
         ...
         <select class="form-control" id="farmaceutico" name="farmaceutico">
          <?php 
                //Trazer todos os registo de remedios

          $res = $pdo->query("SELECT * from utilizadores where nivel = 'Farmacêutico' order by nome asc");
          $dados = $res->fetchAll(PDO::FETCH_ASSOC);
