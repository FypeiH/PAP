...
<div class="row botao-novo">
  <div class="col-md-12">
    ...
    <a href="index.php?acao=<?php echo $pagina; ?>&funcao=novo" type="button" class="btn btn-light">Novo Fornecedor</a>
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
          ...
          <?php if (@$_GET['funcao'] == 'editar') {
            ...
            $resultado = $pdo->query("SELECT * from fornecedores where id = '$id_registo'");
          ...
          } else{$nome_botao = 'Salvar'; echo 'Registo de Fornecedores';} 
      ...
      <div class="modal-body">
        ...
        <form method=POST>
          ...
          <div class="form-group">
               ...
               <select class="form-control" id="remedios" name="remedios">
                ...
                if (@$_GET['funcao'] == 'editar') {
                  ...
                  $res_rem = $pdo->query("SELECT * from remedios where id = '$remedios'");
                  $dados_rem = $res_rem->fetchAll(PDO::FETCH_ASSOC);

                  for ($i=0; $i < count($dados_rem); $i++) { 
                    foreach ($dados_rem[$i] as $key => $value) {
                    }

                    $id_rem = $dados_rem[$i]['id']; 
                    $nome_rem = $dados_rem[$i]['nome'];

                  }

                  echo '<option value="'.$id_rem.'">'.$nome_rem.'</option>';
